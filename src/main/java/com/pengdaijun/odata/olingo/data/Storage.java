package com.pengdaijun.odata.olingo.data;
...
import com.pengdaijun.odata.olingo.util.Util;
...
public class Storage {
	  ...
	  public EntityCollection readEntitySetData(EdmEntitySet edmEntitySet) throws ODataApplicationException {
	    ...
	    if (edmEntitySet.getName().equals(PDJEdmProvider.ES_PRODUCTS_NAME)) {
	      return getProducts();
	    }
	  ...
	  public Entity readEntityData(EdmEntitySet edmEntitySet, List<UriParameter> keyParams)
	    ...
	    if (edmEntityType.getName().equals(PDJEdmProvider.ET_PRODUCT_NAME)) {
